...
//		g2.setBackground(Color.BLACK);	/*Set the background color to black*/
	...
	public void plotString(String string){
		Graphics2D g2 = bufferedImage.createGraphics();
		g2.setColor(new Color(255,255,255));
		g2.setFont(new Font("Helvetica",Font.PLAIN,18));
		g2.drawString(string,(int) (imageSize.width/10),(int) (imageSize.height/10));
		g2.dispose();
	}

	public void plotString(String string,double relX, double relY,int colorIndex){
		Graphics2D g2 = bufferedImage.createGraphics();
		g2.setColor(new Color(brushColor[colorIndex][0],brushColor[colorIndex][1],brushColor[colorIndex][2]));
		g2.setFont(new Font("Helvetica",Font.PLAIN,18));
		g2.drawString(string,(int) (imageSize.width*relX),(int) (imageSize.height*relY));
		g2.dispose();
	}
